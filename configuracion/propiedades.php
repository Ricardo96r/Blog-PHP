<?php
	...
	if (isset($_SESSION['username'])) {
		$pf_op = mysql_query("SELECT idcuenta, cuenta, email, nombre, nacimiento, sexo, imagen_perfil FROM cuentas WHERE email = '$_SESSION[username]'", $conn) or die (mysql_error());
