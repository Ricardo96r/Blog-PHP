...
<div class="form-group">
	<label for="registro-form-cuenta-input" class="control-label">Nombre de usuario</label>
...
<div class="col-md-6">
<div class="form-group">
    <label for="registro-form-contraseña1-input" class="control-label">Contraseña</label>
...
<div class="col-md-6">
<div class="form-group">
    <label for="registro-form-contraseña2-input" class="control-label">Repetir contraseña</label>
...
<div class="form-group">
    <label for="registro-form-correo-input" class="control-label">Correo electrónico</label>
...
<div class="form-group">
    <label for="registro-form-nombres-input" class="control-label">Nombre y apellido</label>
...
<label class="control-label text-center">Nacimiento:</label>
<div class="form-group">
<div class="row">
    <div class="col-md-4">
